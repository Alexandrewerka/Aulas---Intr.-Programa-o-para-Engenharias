...
#include <locale.h>
	...
	int validade(char mat [3][3], char simb, int x, int y){
...
mat[0][0] = mat[1][0] = mat[2][0] = mat[0][1] = mat[1][1] = mat[2][1] = mat[0][2] = mat[1][2] = mat[2][2] = '-';
	...
	//Loop de rodadas, repete até uma condição de vitória ser atingida ou 9 turnos passarem sem vencedores		
	for (i = 1;i<10;i++) {
